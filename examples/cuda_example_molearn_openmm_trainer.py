...
if __name__=='__main__':
    trainer = molearn.OpenMM_Physics_Trainer(device=torch.device('cuda'))
    ...
    trainer.prepare_physics(physics_scaling_factor=0.1, clamp = False)
    runkwargs = dict(log_filename='cuda_openmm_log_file.dat',
                     checkpoint_folder='cuda_openmm_checkpoints',
