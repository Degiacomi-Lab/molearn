...
if __name__=='__main__':
    trainer = molearn.Molearn_Physics_Trainer(device=torch.device('cuda'))
    ...
    runkwargs = dict(log_filename='cuda_molearn_log_file.dat',
                     checkpoint_folder='cuda_molearn_checkpoints',
