...
In order to use them as training data please run the `prepare_example.py` in order to obtain a joined and prepared trajectory. Alternatively, pass them directly to a pdb_data class. 
