...
if __name__=='__main__':
    trainer = molearn.OpenMM_Physics_Trainer(device=torch.device('cpu'))
    ...
    trainer.prepare_physics(physics_scaling_factor=0.0001, clamp = True)
    runkwargs = dict(log_filename='openmm_log_file.dat', checkpoint_folder='checkpoints', max_epochs=100, checkpoint_frequency=1)
